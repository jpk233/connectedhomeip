...
{
    uint16_t data_len = static_cast<uint16_t>(kSigmaParamRandomNumberSize + sizeof(uint16_t) + kSHA256_Hash_Length +
...
CHIP_ERROR CASESession::HandleSigmaR1(System::PacketBufferHandle & msg)
{
    ...
    err = tlvReader.FindElementWithTag(TLV::ContextTag(1), suppTlvReader);
    SuccessOrExit(err);
    ...
    err = tlvReader.FindElementWithTag(TLV::ContextTag(2), suppTlvReader);
    SuccessOrExit(err);
    ...
    err = tlvReader.FindElementWithTag(TLV::ContextTag(3), suppTlvReader);
    SuccessOrExit(err);
    VerifyOrExit(kSHA256_Hash_Length == suppTlvReader.GetLength(), err = CHIP_ERROR_INVALID_TLV_ELEMENT);
    VerifyOrExit(suppTlvReader.GetType() == TLV::kTLVType_ByteString, err = CHIP_ERROR_WRONG_TLV_TYPE);
    ...
    err = tlvReader.FindElementWithTag(TLV::ContextTag(4), suppTlvReader);
    SuccessOrExit(err);
...
CHIP_ERROR CASESession::SendSigmaR2()
{
...

    {
        ...
        SuccessOrExit(err = tlvWriter.PutBytes(TLV::ContextTag(1), mOpCredSet->GetDevOpCred(mTrustedRootId),
                                               mOpCredSet->GetDevOpCredLen(mTrustedRootId)));
        SuccessOrExit(
            err = tlvWriter.PutBytes(TLV::ContextTag(2), sigmaR2Signature, static_cast<uint32_t>(sigmaR2Signature.Length())));
        SuccessOrExit(err = tlvWriter.EndContainer(outerContainerType));
        SuccessOrExit(err = tlvWriter.Finalize());
    ...
    err = AES_CCM_encrypt(msg_R2_Encrypted.Get(), msg_r2_signed_enc_len, nullptr, 0, sr2k, kAEADKeySize, kTBEData2_Nonce,
                          kTBEDataNonceLength, msg_R2_Encrypted.Get(), tag, sizeof(tag));
    SuccessOrExit(err);
...

    {
        ...
        SuccessOrExit(err = tlvWriter.PutBytes(TLV::ContextTag(3), mEphemeralKey.Pubkey(),
                                               static_cast<uint32_t>(mEphemeralKey.Pubkey().Length())));
        SuccessOrExit(err = tlvWriter.PutBytes(TLV::ContextTag(4), msg_R2_Encrypted.Get(), msg_r2_signed_enc_len));
        SuccessOrExit(err = tlvWriter.PutBytes(TLV::ContextTag(5), tag, sizeof(tag)));
        SuccessOrExit(err = tlvWriter.EndContainer(outerContainerType));
...
CHIP_ERROR CASESession::HandleSigmaR2(System::PacketBufferHandle & msg)
{
    ...
    SuccessOrExit(err = tlvReader.FindElementWithTag(TLV::ContextTag(2), suppTlvReader));
    ...
    SuccessOrExit(err = tlvReader.FindElementWithTag(TLV::ContextTag(3), suppTlvReader));
    VerifyOrExit(mRemotePubKey.Length() == suppTlvReader.GetLength(), err = CHIP_ERROR_INVALID_TLV_ELEMENT);
    VerifyOrExit(suppTlvReader.GetType() == TLV::kTLVType_ByteString, err = CHIP_ERROR_WRONG_TLV_TYPE);
    ...
    err = tlvReader.FindElementWithTag(TLV::ContextTag(5), suppTlvReader);
    SuccessOrExit(err);
    VerifyOrExit(suppTlvReader.GetType() == TLV::kTLVType_ByteString, err = CHIP_ERROR_WRONG_TLV_TYPE);
    ...
    err = AES_CCM_decrypt(msg_R2_Encrypted.Get(), msg_r2_encrypted_len, nullptr, 0, tag, kTAGSize, sr2k, kAEADKeySize,
    ...
    err = decryptedDataTlvReader.FindElementWithTag(TLV::ContextTag(1), suppTlvReader);
    SuccessOrExit(err);
    VerifyOrExit(suppTlvReader.GetType() == TLV::kTLVType_ByteString, err = CHIP_ERROR_WRONG_TLV_TYPE);
    ...
    err = decryptedDataTlvReader.FindElementWithTag(TLV::ContextTag(2), suppTlvReader);
    SuccessOrExit(err);
    VerifyOrExit(suppTlvReader.GetType() == TLV::kTLVType_ByteString, err = CHIP_ERROR_WRONG_TLV_TYPE);
...
CHIP_ERROR CASESession::SendSigmaR3()
{
...

    {
        ...
        SuccessOrExit(err = tlvWriter.PutBytes(TLV::ContextTag(1), mOpCredSet->GetDevOpCred(mTrustedRootId),
                                               mOpCredSet->GetDevOpCredLen(mTrustedRootId)));
        SuccessOrExit(
            err = tlvWriter.PutBytes(TLV::ContextTag(2), sigmaR3Signature, static_cast<uint32_t>(sigmaR3Signature.Length())));
        SuccessOrExit(err = tlvWriter.EndContainer(outerContainerType));
        SuccessOrExit(err = tlvWriter.Finalize());
    ...
    err = AES_CCM_encrypt(msg_R3_Encrypted.Get(), msg_r3_encrypted_len, nullptr, 0, sr3k, kAEADKeySize, kTBEData3_Nonce,
                          kTBEDataNonceLength, msg_R3_Encrypted.Get(), tag, sizeof(tag));
    SuccessOrExit(err);
...

    {
        ...
        SuccessOrExit(err);
        err = tlvWriter.PutBytes(TLV::ContextTag(1), msg_R3_Encrypted.Get(), msg_r3_encrypted_len);
        SuccessOrExit(err);
        err = tlvWriter.PutBytes(TLV::ContextTag(2), tag, sizeof(tag));
...
CHIP_ERROR CASESession::HandleSigmaR3(System::PacketBufferHandle & msg)
{
    ...
    err = AES_CCM_decrypt(msg_R3_Encrypted.Get(), msg_r3_encrypted_len, nullptr, 0, tag, kTAGSize, sr3k, kAEADKeySize,
                                              ...
                                              NodeId nodeId, FabricId fabricId, MutableByteSpan & destinationId)
{
    ...
    ReturnErrorOnFailure(hmac.HMAC_SHA256(mIPK, sizeof(mIPK), destinationMessage, sizeof(destinationMessage), destinationId.data(),
                                          destinationId.size()));
